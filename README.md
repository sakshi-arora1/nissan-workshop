...
## Environments
- Preview: https://main--nissan-workshop--sakshi-arora1.hlx.page/
- Live: https://main--nissan-workshop--sakshi-arora1.hlx.live/
...
1. Open the `nissan-workshop` directory in your favorite IDE and start coding :)
